...
def calc_sims(compound_vector, left_vector, right_vector):
...
def experiment4_cases(compound_df, word_vectors):
    """
    ...
    def calc_sims_row(row, vector_dictionary, is_glove):
        ...
        if is_glove:
            lmds = []
            lmd = calc_sims(compound_vectors, left_vectors, right_vectors)
            lmds.append(lmd)
            ...
            for compound_vector, left_vector, right_vector in zip(
                ...
                lmd = calc_sims(compound_vector, left_vector, right_vector)
                lmds.append(lmd)
